...
analyze -format sverilog -vcs "+define+FPV_ON +define+EN_MASKING=1 -assert svaext \
  -f [glob *.scr]"
...
#-------------------------------------------------------------------------
# Use command fsv_generate to create security properties specifying
...
#-------------------------------------------------------------------------
# Check formal verification setup and properties
#-------------------------------------------------------------------------
